  ...
  return (
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          className="relative z-10 mx-auto max-w-4xl text-center text-xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"DSA to Computer Fundamentals, all you need to ace your tech interviews"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
